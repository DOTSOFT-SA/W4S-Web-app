				...
				<div class="panel card-sign">
					...
					<div class="card-body" style="padding-bottom:40px;padding-top:0;">
						...
						<input type="hidden" name="Command" id="Command" value="-1" >
							...
							<div class="row">
								<div class="col-sm-8">
									<div class="checkbox-custom checkbox-default">
										...
										<label for="AgreeTerms">I agree with 
										<a class="mb-1 mt-1 mr-1 modal-sizes" href="#modalLG">terms of use</a></label>
									</div>
								</div>
							...
							<p class="text-center">Already have an account? <a href="index.php?com=login">Είσοδος</a></p>
