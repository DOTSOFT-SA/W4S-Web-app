					...
					<div class="card-body" style="padding-bottom:40px;padding-top:0;">
						<div class="form-group mb-3">
							<a href="/" class="logo float-left">
								<img src='/img/dslogo2.jpg' alt="Entrance" class='retina-ready' width="140px" style="margin-top:30px;">
							</a>
						</div>
						<form id="__PageForm" name="__PageForm" method="post" enctype="multipart/form-data" onSubmit="return PageIsValid();">
							...
							<div class="row">
								<div class="col-sm-12"><img src="/gallery/site/Sticker-website_ETPA_GR.jpg" style="width:400px;margin-top:30px;"></div>
							</div>
						</form>
					</div>
				</div>
