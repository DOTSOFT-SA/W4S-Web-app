			...
			<section class="card">
				...
				<div class="card-body">
					<div class="form-horizontal form-bordered" method="get">
						...
						?>
						<div class="form-group row">
							<!-- <label class="col-lg-3 control-label text-lg-right pt-2">Τύποι αισθητήρων</label>-->
							<!-- <div class="col-lg-2"><label class="control-label text-lg-right pt-2">Αισθητήρες</label></div>-->
							<div class="col-lg-2"><label class="control-label text-lg-right pt-2"> </label></div>
							
							<div class="col-lg-2">
								<label class="col-lg-2 control-label text-lg-right pt-2">1</label>
							...
							<div class="col-lg-2">
								<label class="col-lg-2 control-label text-lg-right pt-2">2</label>
							...
							<div class="col-lg-2">
								<label class="col-lg-2 control-label text-lg-right pt-2">3</label>
							...
							<div class="col-lg-2">
								<label class="col-lg-2 control-label text-lg-right pt-2">4</label>
							...
							<div class="col-lg-2">
								<label class="col-lg-2 control-label text-lg-right pt-2">5</label>
